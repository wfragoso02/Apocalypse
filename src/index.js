...
loader.load( '/JS-PROJECT/blender-files/stage.glb', function (gltf) {
...
const spawnEnemy = () => {
    ...
    loader.load( '/JS-PROJECT/blender-files/real-zombie.glb', function (gltf) {
...
let gun;
loader.load( '/JS-PROJECT/blender-files/Handgun_Game_Blender Gamer Engine.glb', function ( gltf ) {
    gun = gltf.scene; 
